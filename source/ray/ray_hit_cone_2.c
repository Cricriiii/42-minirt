...
/*   Updated: 2026/01/24 18:47:48 by cgajean              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
__attribute__((always_inline, hot))
static inline bool	is_within_cone_height(const t_cone *cone, t_real3 point)
{
...
__attribute__((always_inline, hot))
static inline t_real3	compute_cone_normal(const t_cone *cone, t_real3 point)
{
	t_real3	apex_to_point;
	t_real	projection;
	t_real3	axis_point;
