...
#    Updated: 2026/01/24 18:49:59 by cgajean          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME		:=	miniRT
CC			:=	clang
CFLAGS		:=	-MMD -MP -ffast-math -O3 -flto -march=native -finline-functions -funroll-loops -DLOAD_PRO -g3
SRC_DIR		:=	source
OBJ_DIR		:=	.build
LIBFT_DIR	:=	libft
MLX_DIR		:=	mlx
...
.PHONY: all mlx clean fclean re clean_pro test_wrong test_good 
